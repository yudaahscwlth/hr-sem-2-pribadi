    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Edit Lokasi Kantor</h5>
            </div>
            
            <div class="card-body">
                <form action="{{ route('admin.LokasiKantor.update', $lokasiKantor) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_lokasi') is-invalid @enderror" 
                               ...
                               value="{{ old('nama_lokasi', $lokasiKantor->nama_lokasi) }}" required>
                        @error('nama_lokasi')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.00000001" 
                                               ...
                                               value="{{ old('latitude', $lokasiKantor->latitude) }}" required>
                                        @error('latitude')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.00000001" 
                                               ...
                                               value="{{ old('longitude', $lokasiKantor->longitude) }}" required>
                                        @error('longitude')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="10" max="1000" 
                               ...
                               value="{{ old('radius_meter', $lokasiKantor->radius_meter) }}" required>
                        @error('radius_meter')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <span id="coord-display">{{ $lokasiKantor->latitude }}, {{ $lokasiKantor->longitude }}</span>
                </div>
                <div class="mb-3">
                    <strong>Radius:</strong><br>
                    <span id="radius-display">{{ $lokasiKantor->radius_meter }}</span> meter
                </div>
                <div class="mb-3">
